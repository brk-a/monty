 ...
 * @fd: ptr to a file descriptor of an open file
 */
...
/**
 * interpret_line - Separates each line into tokens to det'n
 * the fn to call.
 * @lineptr: str representing a line in a file.
 * @line_number: Line no. for the opcode.
...
/**
 * find_func - Finds the appropiate function to run the opcode instructions.
 * @opcode: The op code; push, pall etc
 * @value: The possible val for the op.
 * @ln: Line n0. for the opcode.
 * @format: Format specifier. If 0 Nodes will be entered as a stack.
 * if 1 nodes will be entered as a queue.
 */
...
/**
 * call_fun - Calls the rqd fn.
 * @f: Ptr to the fn that is about to be called.
 * @op: string representing the opcode.
 * @val: str representing a numeric val.
 * @ln: line no. for the instruction.
 * @format: Format specifier. If 0 Nodes will be entered as a stack.
 * if 1 nodes will be entered as a queue.
 */
